...
<ul class="nav nav-pills">
    <li class="active"><a href="${activitiCtx}/management/identity/user/list"><i class="icon-user"></i>用户管理</a></li>
    <li><a href="${activitiCtx}/management/identity/group/list"><i class="icon-list"></i>组管理</a></li>
</ul>
<hr>
