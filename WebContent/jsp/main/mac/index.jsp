...
<body class="easyui-layout">
	...
	<div region="north" split="false" border="false"
		...
		<span style="float: right; padding-right: 20px;padding-top:15px;" class="head">
			...
			style="padding-left: 5px; font-size: 22px; height: 97px; line-height: 48px; margin-left: 30px;">LOANPLUS-CC | TOOL</span>
	</div>
	...
	<input id="modle" name="modle" type="hidden" value="mac"></input>
